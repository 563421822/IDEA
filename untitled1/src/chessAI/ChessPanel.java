...
public class ChessPanel extends JPanel {
    ...
    //棋子位置集合
    public final List<Location> list = new ArrayList<>();
    //棋盘单元格的长度
    final int row = 30;
    //棋盘每行第一个点与左侧的距离
    final int margin = 20;
    ...
    final int rowper = 15;
    //棋子半径
    final int chessRadius = 13;
    //棋盘背景颜色
    final Color bgColor = new Color(246, 214, 159);
    //棋盘线颜色
    final Color lineColor = new Color(164, 135, 81);
    //星的颜色
    final Color pointColor = new Color(116, 88, 49);
    //字体
